...
<head>
    ...
    <style>
        ...
        .register-page { display: flex; align-items: center; justify-content: center; height: 100vh; }
        .register-card {
            background: #fff;
            padding: 40px 25px;
            border-radius: 20px;
        ...
        .register-card h2 { font-weight: 700; color: #F8991D; }
        ...
        .btn-orange { background-color: #F8991D; color: #fff; font-weight: 600; border-radius: 10px; padding: 10px; width: 100%; transition: .3s; }
        .btn-orange:hover { background-color: #e68712; }
        .text-orange { color: #F8991D; }
        .text-orange:hover { color: #e68712; }
    </style>
</head>
<body class="register-page">
    <div class="register-card text-center">
        ...
        <p class="text-center mt-3 mb-0">Sudah punya akun? <a href="{{ route('login') }}" class="text-orange fw-bold">Masuk</a></p>
    </div>
</body>
</html>
